---
title: '[Python for Data Science](https://github.com/MingChen0919/python-for-data-science)'
output:
    html_document:
      highlight: pygments
---
...
file_tree = function(dir = '.'){
  ...
  github_repo_url = 'https://github.com/MingChen0919/python-for-data-science/blob/master/'
  tags$ul(
    {
      if (length(files) > 0) {
